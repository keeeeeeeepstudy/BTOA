...
for ii in range(args.itr):
    ...
    setting = '{}_{}_lr{}_pl{}_ol{}_opt{}_tb{}_seed{}_aug{}_{}'.format(method_name, args.data,args.learning_rate, args.pred_len,args.online_learning, args.opt, args.test_bsz,fix_seed,args.aug_number,suffix)

    init_dl_program(args.gpu, seed=fix_seed)
    args.finetune_model_seed = fix_seed
