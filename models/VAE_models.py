...
class ConvEncoder_ECL(nn.Module):
    def __init__(self, output_dim):
        ...
        self.conv1 = nn.Conv2d(1, 32, (9, 2), stride=(3,5))  
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 32, (3, 3), stride=(3,5))  
        self.bn2 = nn.BatchNorm2d(32)
        self.conv3 = nn.Conv2d(32, 64, (3, 3), stride=(3,5))  
        self.bn3 = nn.BatchNorm2d(64)
...
class ConvDecoder_ECL(nn.Module):
    def __init__(self, input_dim):
        ...
        self.conv1 = nn.ConvTranspose2d(input_dim, 512, (2, 321), stride=(1, 1), padding=0)  # 2 x 9
        self.bn1 = nn.BatchNorm2d(512)
        self.conv2 = nn.ConvTranspose2d(512, 128, (4, 1), stride=(6,1), padding=(1,0))  # 8 x 9
        self.bn2 = nn.BatchNorm2d(128)
        self.conv3 = nn.ConvTranspose2d(128, 64, (4, 1), stride=(2,1), padding=(1,0))  # 16 x 9
...
class ConvEncoder_WTH(nn.Module):
    def __init__(self, output_dim):
        ...
        self.bn1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 32, (3, 3), stride=(3,2))  
        self.bn2 = nn.BatchNorm2d(32)
        self.conv3 = nn.Conv2d(32, 64, (3, 3), stride=(3,2))  
        self.bn3 = nn.BatchNorm2d(64)
...
class ConvDecoder_WTH(nn.Module):
    def __init__(self, input_dim):
        ...
        self.conv1 = nn.ConvTranspose2d(input_dim, 512, (2, 12), stride=(1, 1), padding=0)  # 2 x 9
        self.bn1 = nn.BatchNorm2d(512)
        self.conv2 = nn.ConvTranspose2d(512, 128, (4, 1), stride=(6,1), padding=(1,0))  # 8 x 9
        self.bn2 = nn.BatchNorm2d(128)
        self.conv3 = nn.ConvTranspose2d(128, 64, (4, 1), stride=(2,1), padding=(1,0))  # 16 x 9
...
class ConvDecoder_traffic(nn.Module):
    def __init__(self, input_dim):
        ...
        self.conv1 = nn.ConvTranspose2d(input_dim, 512, (2, 862), stride=(1, 1), padding=0)  # 2 x 9
        self.bn1 = nn.BatchNorm2d(512)
        self.conv2 = nn.ConvTranspose2d(512, 128, (4, 1), stride=(6,1), padding=(1,0))  # 8 x 9
        self.bn2 = nn.BatchNorm2d(128)
        self.conv3 = nn.ConvTranspose2d(128, 64, (4, 1), stride=(2,1), padding=(1,0))  # 16 x 9
